...
# sols = predict(rmodel, bbTest[,sampleFeats-1], type="prob")
...
params = list(labeled="/home/results/bbTrain.desc", unlabeled="/home/results/extra_data_sample.desc",
                  ...
                  parallel=T, cpus=4, weights=c(1,0), cl=cl,returnResults=F,method="lda", OVA=F)
...
iterativeParams = list(
  ...
  iterativemethod="gaSimple",#salitebin",#"randbin",
  iterativemethodparams=list(replacerate=.1, sadist=2, mutrate=1/ncol(bbTrain)/100, gacontdist=1),
  optEval="bbEvalMain",
